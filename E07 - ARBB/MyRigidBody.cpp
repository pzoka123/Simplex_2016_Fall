...
void MyRigidBody::SetModelMatrix(matrix4 a_m4ModelMatrix)
{
	...
	v3Corner[4] = m_v3MaxL;
	v3Corner[5] = vector3(m_v3MinL.x, m_v3MinL.y, m_v3MaxL.z);
	v3Corner[6] = vector3(m_v3MaxL.x, m_v3MinL.y, m_v3MaxL.z);
	v3Corner[7] = vector3(m_v3MinL.x, m_v3MaxL.y, m_v3MaxL.z);
	...
	//Set the global max and min to be the first corner
